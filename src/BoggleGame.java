...
public class BoggleGame extends JFrame {
     ...
     * End user should input nothing for a classic 4x4 board, or enter something like:
     *
     * 3 7
     * for a 3 x 7 board, etc.
     */
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                if (rows <= 3 || cols <= 3 || rows > 10 || cols > 10) {
                    throw new java.lang.IllegalArgumentException("Rows and columns must be between 4 and 10." +
